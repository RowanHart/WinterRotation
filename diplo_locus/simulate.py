...
def simulateSamples (Ne, allS1, allS2, mAlpha, mBeta, times, sampleSizes, initCond=None, initFreq=None, numReplicates=1,
                        deltaT=0.05, condInitSeg=False, initGridResolution=None, initProbs=None, initValues=None,
    ...
    if (initCond == "initFreq"):
        ...
        if (initCond in ["discBeta", "discBetaSel"]):
            # here we need grids
            assert (initGridResolution != None), "'initGridResolution' needed, but not given."
        ...
        if (initCond == "discBeta"):
            ...
            samplingProbs = diffusion_core.Stationary.stationarySelectionBeta (Ne, initMAlpha, initMBeta, initS1, initS2, yGrid, weights)
